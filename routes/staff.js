...
router.post('/', verifyLogin, (req, res) => {
  ...
  Promise.all([staffHelper.viewPresent(staff,stdId), staffHelper.stdCount(staff),staffHelper.students(staff)]).then((student) => {
    let stdResult = student[0]
    let stdCount = student[1]
